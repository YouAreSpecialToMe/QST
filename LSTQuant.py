...
@dataclass
class LSTQuantConfig(PretrainedConfig):
    ...
    # quantization_config: BitsAndBytesConfig = field(default_factory=BitsAndBytesConfig)
    # task: str = "nlu"
...
class AdapterLinear(nn.Module):
    ...
    def __init__(self,
        ...
        self.adapter_A = nn.Linear(in_features, r)
        nn.init.kaiming_uniform_(self.adapter_A.weight, a=math.sqrt(5))
        self.adapter_B = nn.Linear(r, out_features)
